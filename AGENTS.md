...
# Re-render an existing script without an API key:
docker run -v $(pwd)/output:/app/output \
  ralph-lecture --from-script output/how-to-use-sed
```
...
# Re-render an existing script.json without an API key
python main.py --from-script output/how-to-use-sed
...
remotion-src/
  ...
  components/
examples/
  how-to-use-sed/  — first rendered lecture (163s, 1920×1080)
specs/
